...
class Tic_Tac_Toe_logic:
    ...
    def find_winning_move(self, side):
        ...
        if self.board[0][1] == self.board[1][1] == side \
                and self.board[2][1] == BLANK:
            return (2,1 )
        elif self.board[2][1] == self.board[1][1] == side \
                and self.board[0][1] == BLANK:
            return (0, 1)
        elif self.board[1][0] == self.board[1][1] == side \
                and self.board[1][2] == BLANK:
            return (1, 2)
        elif self.board[0][0] == self.board[1][0] == side \
                and self.board[2][0] == BLANK:
            return (2, 0)
        elif self.board[2][0] == self.board[2][2] == side \
                and self.board[2][1] == BLANK:
            return (2, 1)
        elif self.board[0][0] == self.board[0][2] == side \
                and self.board[0][1] == BLANK:
            return (0, 1)
        elif self.board[0][0] == self.board[2][0] == side \
                and self.board[1][0] == BLANK:
            return (1, 0)
        elif self.board[2][0] == self.board[2][1] == side \
                and self.board[2][2] == BLANK:
            return (2, 2)
        elif self.board[0][2] == self.board[2][2] == side \
                and self.board[1][2] == BLANK:
            return (1, 2)
        elif self.board[1][1] == self.board[1][2] == side \
                and self.board[1][0] == BLANK:
            return (1,0 )
        elif self.board[2][2] == self.board[1][2] == side \
                and self.board[0][2] == BLANK:
            return(0,2)
        else:
            return ()
